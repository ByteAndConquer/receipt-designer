...
# ============================================================================
# Path setup: Add parent of repo root to sys.path for package imports
# ============================================================================
# The UI modules use relative imports (from ..core.models), so we need to
# add the parent of the project root so "receipt_designer" is a proper package.
ROOT = Path(__file__).resolve().parents[1]  # receipt_designer/
PARENT = ROOT.parent  # parent directory containing receipt_designer/
